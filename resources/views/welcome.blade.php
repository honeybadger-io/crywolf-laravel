    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="m-b-md">
                    <a class="btn" href="/fail?foo=bar&baz=badgers">Click here to throw a test exception.</a>
                </div>

                <div class="m-b-md">
                    <p class="desc">This is a sample Laravel application which reports errors to <a href="https://www.honeybadger.io/for/laravel" target="_blank">Honeybadger.io</a>.<br>The source is on <a href="https://github.com/honeybadger-io/crywolf-laravel" target="_blank">GitHub</a>.</p>
                </div>
            </div>
        </div>
    </body>
