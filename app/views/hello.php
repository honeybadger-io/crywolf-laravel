...
<body>
	<div class="welcome">
		...
		<h1>Honeybadger.io Example for PHP/Laravel</h1>
		<p>This is a sample Laravel application which reports errors to <a href="https://www.honeybadger.io/for/php" target="_blank">Honeybadger.io</a>. <a href="https://github.com/honeybadger-io/crywolf-laravel" target="_blank">Check out the source on GitHub</a>.</p>
		<p><a href="/fail">Click here to send a test error to Honeybadger.io</a></p>
	</div>
</body>
</html>
